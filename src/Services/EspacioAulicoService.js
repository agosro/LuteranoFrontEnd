...
export const listarEspaciosAulicos = async (token) => {
  void token
  const data = await httpClient.get('/espacio-aulico/list')
...
export const crearEspacioAulico = async (token, espacio) => {
  void token
  const data = await httpClient.post('/espacio-aulico/create', espacio)
...
export const editarEspacioAulico = async (token, espacio) => {
  void token
  const data = await httpClient.put('/espacio-aulico/update', espacio)
...
export const eliminarEspacioAulico = async (token, id) => {
  void token
  const data = await httpClient.delete(`/espacio-aulico/delete/${id}`)
