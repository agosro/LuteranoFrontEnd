...
export default function ReporteNotasAlumnos() {
  ...
  // Auto-generar reporte si viene autoGenerate=true
  useEffect(() => {
    if (autoGenerate && alumnoId && anio && !hasAutoGenerated && !loading) {
  ...
  }, [autoGenerate, alumnoId, anio, hasAutoGenerated, loading]);
